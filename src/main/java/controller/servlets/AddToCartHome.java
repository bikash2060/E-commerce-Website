...
@WebServlet(asyncSupported = true, urlPatterns = {StringUtils.INDEX_CART_SERVLET })
public class AddToCartHome extends HttpServlet {
		...
		if(!userHasCart) {
			...
			switch(result) {
			    ...
			    case 0:
			        ...
			        request.getRequestDispatcher(StringUtils.INDEX_URL).forward(request, response);
			        break;
			    case -1:
